...
* ERC165.register_interface允许合约设置和通信它们支持的接口。这遵循OpenZeppelin的[ERC165Storage](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/utils/introspection/ERC165Storage.sol)。
...
此外，这个实现将支持的接口存储在一个映射中（类似于OpenZeppelin的[ERC165Storage](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/utils/introspection/ERC165Storage.sol)）。
