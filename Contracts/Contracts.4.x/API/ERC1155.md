...
* 如果to引用一个智能合约，则它必须实现*IERC1155Receiver.onERC1155BatchReceived*并返回接受magic value。
...
* 如果to是一个智能合约，则必须实现*IERC1155Receiver.onERC1155Received*并返回接受magic value。
...
发出 *TransferBatch* 事件。
要求：
* 如果 to 引用了一个智能合约，则该智能合约必须实现 *IERC1155Receiver.onERC1155BatchReceived 并返回接受magic value。
...
要求：
* to不能是零地址。
* 如果to是一个智能合约，则必须实现*IERC1155Receiver.onERC1155Received*并返回接受的magic value。
...
如果 to 引用了一个智能合约，则该合约必须实现 *IERC1155Receiver.onERC1155BatchReceived*，并返回接受magic value。
